...
#define MATEKBD_KEYBOARD_DRAWING_CLASS(clazz)                           \
  (G_TYPE_CHECK_CLASS_CAST((clazz), matekbd_keyboard_drawing_get_type() \
                                        MatekbdKeyboardDrawingClass))
#define MATEKBD_IS_KEYBOARD_DRAWING(obj) \
  G_TYPE_CHECK_INSTANCE_TYPE((obj), matekbd_keyboard_drawing_get_type())
...
typedef enum {
  ...
  MATEKBD_KEYBOARD_DRAWING_POS_FIRST = MATEKBD_KEYBOARD_DRAWING_POS_TOPLEFT,
  MATEKBD_KEYBOARD_DRAWING_POS_LAST = MATEKBD_KEYBOARD_DRAWING_POS_BOTTOMRIGHT
...
gboolean matekbd_keyboard_drawing_render(MatekbdKeyboardDrawing *kbdrawing,
                                         ...
                                         double height, gdouble dpi_x,
                                         gdouble dpi_y);
gboolean matekbd_keyboard_drawing_set_keyboard(
    MatekbdKeyboardDrawing *kbdrawing, XkbComponentNamesRec *names);
...
void matekbd_keyboard_drawing_set_track_modifiers(
    MatekbdKeyboardDrawing *kbdrawing, gboolean enable);
void matekbd_keyboard_drawing_set_track_config(
    MatekbdKeyboardDrawing *kbdrawing, gboolean enable);

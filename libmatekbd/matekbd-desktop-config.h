...
extern void matekbd_desktop_config_load_from_gsettings(
    MatekbdDesktopConfig *config);

extern void matekbd_desktop_config_save_to_gsettings(
    MatekbdDesktopConfig *config);

extern gboolean matekbd_desktop_config_activate(MatekbdDesktopConfig *config);

extern gboolean matekbd_desktop_config_load_group_descriptions(
...
extern void matekbd_desktop_config_lock_next_group(
    MatekbdDesktopConfig *config);

extern void matekbd_desktop_config_lock_prev_group(
    MatekbdDesktopConfig *config);
